...
class AppointmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Appointment" do
    ...
    fill_in "Appclient", with: @appointment.appClient
    fill_in "Appdate", with: @appointment.appDate
    fill_in "Applength", with: @appointment.appLength
    fill_in "Apptime", with: @appointment.appTime
    fill_in "Apptype", with: @appointment.appType
